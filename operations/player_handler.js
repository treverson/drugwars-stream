                  ...
                  db.query(query,[character.name],
                      function (err, result) {
                          if (err) {
                              ...
                              {
                                drug_balance = drug_balance + (drug_balance*(buildings.building_4_level*(100/2000)))
                                weapon_balance = weapon_balance + (weapon_balance*(buildings.building_4_level*(100/2000)))
                                console.log('applied bonus %' + (buildings.building_4_level*(100/2000)))
                              }
